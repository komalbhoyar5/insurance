								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>
										...
										?>
															...
															<div class="dropdown-menu dropdown-menu-right">
																<ul>
																	...
																	<?php
											                       	...
											                       	?>
																	<li>
																		<a class="dropdown-item" type="button" data-toggle="modal" data-target="#<?php echo $relationship['Relationship']['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
																	</li>
																	<?php } ?>
																</ul>
															</div>
											...
											<div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="<?php echo $relationship['Relationship']['id']; ?>">
