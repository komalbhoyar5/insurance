<div id="page-wrapper">
            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-right">
                            <div class="huge">1,30,000</div>
                            <div>Total Policy</div>
                        </div>
                    </div>
                </div>
                <a href="#">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="panel panel-default darkslategray">
                <div class="panel-heading">
...
<?php
    echo $this->Html->script('../admin/js/morris.min.js'); 
    echo $this->Html->script('../admin/js/morris-data.js'); 
?>