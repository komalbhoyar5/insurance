                            ...
                            <?php echo $this->Form->create('Plan', array('id' => 'Plan')); ?>
								...
								<div class="col-sm-12 policy_type">
                                    <table>
                                        ...
                                        <?php 
                                            foreach ($this->request->data['PlanDependent'] as $key => $value) { 
                                                if ($key == 0) { ?>
                                                    <tr class="addonerow"  id="addnewType_0">
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input('PlanDependent.0.id');
                                                                echo $this->Form->input(
                                            ...
                                            <?php       
                                                    ...
                                                    <tr class="addonerow"  id="del_<?php echo $value['id']; ?>">
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input('PlanDependent.'.$key.'.id');
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.dependent_type_id',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                        'options' => $dependent_list
                                                        ...
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.cover_benefits_type',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                        'options' => $cover_list
                                                        ...
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.living_allowance_per_month',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                    )
                                                        ...
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.living_allowance_for_month',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                    )
                                                        ...
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.fixed_premium',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                    )
                                                        ...
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.employer_contribution',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                    )
                                                        ...
                                                        <td>
                                                            <?php
                                                                echo $this->Form->input(
                                                                    'PlanDependent.'.$key.'.employee_contribution',
                                                                    array(
                                                                        'class' => 'form-control',
                                                                        'label' => false,
                                                                    )
                                ...
                                <div class="form-group col-sm-12" style="margin-top:20px;">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit" value="submit" id="<?php echo $key ?>">Save</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.col-lg-12 (nested) -->
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $( "body" ).on( "click",'.removetype', function() {
            ...
            formData = {
                'plan_id' : '<?php echo $id ?>',
                'plandependent_id' : parent.split('_')[1]
            };
            console.log(formData);

            url = '<?php echo Router::url(array('controller'=>'plans','action'=>'deletePlandependancy'));?>',
            $.ajax({
                url: url,
                type: 'POST',
                data: formData,
                ...
                success: function (resp) {
                    if (resp == 'true') {
                        setTimeout(function() {
                            ...
                            toastr.success("Dependent details has been deleted.", 'success');
                        ...
                        toastr.error("Dependent details could not be deleted. Please, try again.", 'Failed');
